<template>
  <div class="relative wrap overflow-hidden p-10 h-full">
    <div
      class="border-2-2 absolute border-opacity-20 border-gray-700 h-full border hidden lg:block"
      style="left: 50%"
    />

    <div v-if="!isUnitsLoaded">
      <div v-for="(unit, i) of numSkeletonCards" :key="i">
        <div
        ...
        >
          ...
          <div
            class="z-20 items-center order-1 shadow-xl w-12 h-12 rounded-full hidden lg:flex justify-center bg-gray-400"
          >
          ...
          <div
            class="order-1 md:w-1/3 lg:w-2/5 w-full items-center max-w-md flex-1"
          >
    ...
    <div v-else>
      <div v-for="(unit, i) of units" :key="i">
        ...
        >
          ...
          <div
            class="z-20 items-center order-1 shadow-xl w-12 h-12 rounded-full hidden lg:flex justify-center"
            :class="{
              'bg-blue-400': i === firstIncompleteIndex,
