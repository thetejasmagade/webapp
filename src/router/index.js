...
function getPostRedirects() {
  return [
    ...
    },
    {
      ...
      redirect: { path: `/tracks/algorithms-and-data-structures` },
    },
    {
      path: "/:pathMatch(.*)*",
      redirect: "/",
...
function getPreRedirects() {
  return [
    ...
    {
      path: "/tracks/golang",
      redirect: { path: "/learn/learn-http" },
    },
    {
      path: "/tracks/algorithms-and-data-structures",
      redirect: { path: "/learn/learn-algorithms" },
    },
    {
      path: "/courses/browse",
