import { startSubscriptionPlanCheckout } from "@/lib/cloudClient.js";

import { loadStripe } from "@stripe/stripe-js";

import { eventBeginCheckout } from "@/lib/analytics.js";
...
export async function checkout(price) {
  ...
  const checkoutSession = await startSubscriptionPlanCheckout(
    price.ID,
    window.Rewardful ? window.Rewardful.referral : null
  );
